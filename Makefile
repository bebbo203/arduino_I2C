...
OBJS=avr_common/uart.o libs/misc_utils.c libs/queue.c libs/clock.c libs/write.c

# put here the additional header files needed for compilation
HEADERS=avr_common/uart.h libs/queue.h libs/misc_utils.h libs/clock.h libs/write.h
